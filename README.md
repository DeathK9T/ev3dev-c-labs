...
9. [Лабораторная №7: Многопоточность и датчик цвета](labs/7_Многопоточность_и_датчик_цвета.md)
10. [Лабораторная №8: Пропорциональное управление](labs/8_Пропорциональное_управление.md)
11. [Лабораторная №9: Алгоритм перехвата управления в системе параллельно_исполняемых потоков](labs/9_Алгоритм_перехвата_управления_в_системе_параллельно_исполняемых_потоков.md)
12. [Лабораторная №10: Система флагов и навигация](labs/10_Система_флагов_и_навигация.md)
